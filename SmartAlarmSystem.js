...
document.getElementById("sendPin").addEventListener("click", function () 
{
  ...
  fetch('http://192.168.68.111/send', 
  {
    method: 'POST',
    headers: {
...
{
  fetch('http://192.168.68.111/Breach')  //gets the data from the board
...
function updatePir1() 
{
  fetch('http://192.168.68.111/pir1')  //gets the data from the board
    .then(response => response.text())//makes it a text type
    .then(data => {
      // Update the content of the <p> tag with id 'msg' to display the string
...
function updatePir2() 
{
  fetch('http://192.168.68.111/pir2')  //gets the data from the board
    .then(response => response.text())//makes it a text type
    .then(data => {
      // Update the content of the <p> tag with id 'msg' to display the string
...
function updateMic1() 
{
  fetch('http://192.168.68.111/mic1')  //gets the data from the board
    .then(response => response.text())//makes it a text type
    .then(data => {
      // Update the content of the <p> tag with id 'msg' to display the string
...
function updateMic2() 
{
  fetch('http://192.168.68.111/mic2')  //gets the data from the board
    .then(response => response.text())//makes it a text type
    .then(data => {
      // Update the content of the <p> tag with id 'msg' to display the string
